...
execute as @a[limit=1,scores={start=1}] at @s run summon minecraft:armor_stand ~ 0 ~ {Marker:1b,Invisible:1b,Invulnerable:1b,Tags:["dun","dungeon7"]}

execute as @a[limit=1,scores={start=1}] at @s run summon minecraft:armor_stand ~ 0 ~ {Marker:1b,Invisible:1b,Invulnerable:1b,Tags:["dun","dungeon8"]}

execute as @a[limit=1,scores={start=1}] at @s run summon minecraft:armor_stand ~ 0 ~ {Marker:1b,Invisible:1b,Invulnerable:1b,Tags:["dun","dungeon9"]}

execute as @a[limit=1,scores={start=1}] at @s run summon minecraft:armor_stand ~ 0 ~ {Marker:1b,Invisible:1b,Invulnerable:1b,Tags:["dun","dungeon10"]}

execute as @e[type=minecraft:armor_stand,tag=gen] at @s positioned ~ ~ ~50 if blocks ~ ~ ~ ~ ~ ~ ~ ~ ~ all unless entity @e[type=minecraft:armor_stand,tag=gen,distance=..1] unless block ~ ~ ~ barrier run summon minecraft:armor_stand ~ ~ ~ {Marker:1b,Invisible:1b,Invulnerable:1b,Tags:["gen"]}
...
execute as @e[type=minecraft:armor_stand,tag=gen,tag=!fin,tag=struct,tag=!dun1,tag=!dun2,tag=!dun3,tag=!dun4,tag=!dun5] at @s as @e[type=armor_stand,tag=dun,limit=1,sort=random,tag=!dungeon1,tag=!dungeon2,tag=!dungeon4,tag=!dungeon5] if entity @s[tag=dungeon6] run tag @e[type=armor_stand,limit=1,sort=nearest,tag=gen,tag=struct] add dun6

execute as @e[type=minecraft:armor_stand,tag=gen,tag=!fin,tag=struct,tag=!dun1,tag=!dun2,tag=!dun3,tag=!dun4,tag=!dun5,tag=!dun6] at @s as @e[type=armor_stand,tag=dun,limit=1,sort=random,tag=!dungeon1,tag=!dungeon2,tag=!dungeon4,tag=!dungeon5,tag=!dungeon6] if entity @s[tag=dungeon7] run tag @e[type=armor_stand,limit=1,sort=nearest,tag=gen,tag=struct] add dun7

execute as @e[type=minecraft:armor_stand,tag=gen,tag=!fin,tag=struct,tag=!dun1,tag=!dun2,tag=!dun3,tag=!dun4,tag=!dun5,tag=!dun6,tag=!dun7] at @s as @e[type=armor_stand,tag=dun,limit=1,sort=random,tag=!dungeon1,tag=!dungeon2,tag=!dungeon4,tag=!dungeon5,tag=!dungeon6,tag=!dungeon7] if entity @s[tag=dungeon8] run tag @e[type=armor_stand,limit=1,sort=nearest,tag=gen,tag=struct] add dun8

execute as @e[type=minecraft:armor_stand,tag=gen,tag=!fin,tag=struct,tag=!dun1,tag=!dun2,tag=!dun3,tag=!dun4,tag=!dun5,tag=!dun6,tag=!dun7,tag=!dun8] at @s as @e[type=armor_stand,tag=dun,limit=1,sort=random,tag=!dungeon1,tag=!dungeon2,tag=!dungeon4,tag=!dungeon5,tag=!dungeon6,tag=!dungeon7,tag=!dungeon8] if entity @s[tag=dungeon9] run tag @e[type=armor_stand,limit=1,sort=nearest,tag=gen,tag=struct] add dun9

execute as @e[type=minecraft:armor_stand,tag=gen,tag=!fin,tag=struct,tag=!dun1,tag=!dun2,tag=!dun3,tag=!dun4,tag=!dun5,tag=!dun6,tag=!dun7,tag=!dun8,tag=!dun9] at @s as @e[type=armor_stand,tag=dun,limit=1,sort=random,tag=!dungeon1,tag=!dungeon2,tag=!dungeon4,tag=!dungeon5,tag=!dungeon6,tag=!dungeon7,tag=!dungeon8,tag=!dungeon9] if entity @s[tag=dungeon10] run tag @e[type=armor_stand,limit=1,sort=nearest,tag=gen,tag=struct] add dun10
...
execute as @e[type=minecraft:armor_stand,tag=gen,tag=!fin,tag=struct,tag=dun7] at @s run summon minecraft:armor_stand ~ 200 ~ {Tags:["fall7"],Invisible:1b}

execute as @e[type=minecraft:armor_stand,tag=gen,tag=!fin,tag=struct,tag=dun8] at @s run summon minecraft:armor_stand ~ 200 ~ {Tags:["fall8"],Invisible:1b}

execute as @e[type=minecraft:armor_stand,tag=gen,tag=!fin,tag=struct,tag=dun9] at @s run summon minecraft:armor_stand ~ 200 ~ {Tags:["fall9"],Invisible:1b}
...
execute as @e[type=minecraft:armor_stand,tag=fall6,nbt={OnGround:1b}] at @s unless block ~ ~ ~ water unless block ~ ~ ~ seagrass unless block ~ ~ ~ tall_seagrass unless block ~ ~ ~ kelp_plant run setblock ~ ~ ~ minecraft:structure_block[mode=load]{metadata:"",mirror:"NONE",ignoreEntities:0b,powered:0b,seed:0L,author:"?",rotation:"NONE",posX:-16,mode:"LOAD",posY:-9,posZ:-16,integrity:1.0f,showair:0b,name:"minecraft:dungeon6",showboundingbox:1b}

execute as @e[type=minecraft:armor_stand,tag=fall6,nbt={OnGround:1b}] at @s if block ~ ~ ~ water run setblock ~ ~ ~ minecraft:structure_block[mode=load]{metadata:"",mirror:"NONE",ignoreEntities:0b,powered:0b,seed:0L,author:"?",rotation:"NONE",posX:-6,mode:"LOAD",posY:-1,posZ:-7,integrity:1.0f,showair:0b,name:"minecraft:dungeon6water",showboundingbox:1b}

execute as @e[type=minecraft:armor_stand,tag=fall6,nbt={OnGround:1b}] at @s if block ~ ~ ~ kelp_plant run setblock ~ ~ ~ minecraft:structure_block[mode=load]{metadata:"",mirror:"NONE",ignoreEntities:0b,powered:0b,seed:0L,author:"?",rotation:"NONE",posX:-6,mode:"LOAD",posY:-1,posZ:-7,integrity:1.0f,showair:0b,name:"minecraft:dungeon6water",showboundingbox:1b}

execute as @e[type=minecraft:armor_stand,tag=fall6,nbt={OnGround:1b}] at @s if block ~ ~ ~ seagrass run setblock ~ ~ ~ minecraft:structure_block[mode=load]{metadata:"",mirror:"NONE",ignoreEntities:0b,powered:0b,seed:0L,author:"?",rotation:"NONE",posX:-6,mode:"LOAD",posY:-1,posZ:-7,integrity:1.0f,showair:0b,name:"minecraft:dungeon6water",showboundingbox:1b}

execute as @e[type=minecraft:armor_stand,tag=fall6,nbt={OnGround:1b}] at @s if block ~ ~ ~ tall_seagrass run setblock ~ ~ ~ minecraft:structure_block[mode=load]{metadata:"",mirror:"NONE",ignoreEntities:0b,powered:0b,seed:0L,author:"?",rotation:"NONE",posX:-6,mode:"LOAD",posY:-1,posZ:-7,integrity:1.0f,showair:0b,name:"minecraft:dungeon6water",showboundingbox:1b}
...
execute as @e[type=minecraft:armor_stand,tag=fall7,nbt={OnGround:1b}] at @s unless block ~ ~ ~ water unless block ~ ~ ~ seagrass unless block ~ ~ ~ tall_seagrass unless block ~ ~ ~ kelp_plant run setblock ~ ~ ~ minecraft:structure_block[mode=load]{metadata:"",mirror:"NONE",ignoreEntities:0b,powered:0b,seed:0L,author:"?",rotation:"NONE",posX:-4,mode:"LOAD",posY:-7,posZ:-3,integrity:1.0f,showair:0b,name:"minecraft:dungeon7",showboundingbox:1b}

execute as @e[type=minecraft:armor_stand,tag=fall7,nbt={OnGround:1b}] at @s if block ~ ~ ~ water run setblock ~ ~ ~ minecraft:structure_block[mode=load]{metadata:"",mirror:"NONE",ignoreEntities:0b,powered:0b,seed:0L,author:"?",rotation:"NONE",posX:-6,mode:"LOAD",posY:-2,posZ:-5,integrity:1.0f,showair:0b,name:"minecraft:dungeon3water",showboundingbox:1b}

execute as @e[type=minecraft:armor_stand,tag=fall7,nbt={OnGround:1b}] at @s if block ~ ~ ~ kelp_plant run setblock ~ ~ ~ minecraft:structure_block[mode=load]{metadata:"",mirror:"NONE",ignoreEntities:0b,powered:0b,seed:0L,author:"?",rotation:"NONE",posX:-6,mode:"LOAD",posY:-2,posZ:-5,integrity:1.0f,showair:0b,name:"minecraft:dungeon3water",showboundingbox:1b}

execute as @e[type=minecraft:armor_stand,tag=fall7,nbt={OnGround:1b}] at @s if block ~ ~ ~ seagrass run setblock ~ ~ ~ minecraft:structure_block[mode=load]{metadata:"",mirror:"NONE",ignoreEntities:0b,powered:0b,seed:0L,author:"?",rotation:"NONE",posX:-6,mode:"LOAD",posY:-2,posZ:-5,integrity:1.0f,showair:0b,name:"minecraft:dungeon3water",showboundingbox:1b}

execute as @e[type=minecraft:armor_stand,tag=fall7,nbt={OnGround:1b}] at @s if block ~ ~ ~ tall_seagrass run setblock ~ ~ ~ minecraft:structure_block[mode=load]{metadata:"",mirror:"NONE",ignoreEntities:0b,powered:0b,seed:0L,author:"?",rotation:"NONE",posX:-6,mode:"LOAD",posY:-2,posZ:-5,integrity:1.0f,showair:0b,name:"minecraft:dungeon3water",showboundingbox:1b}
...
execute as @e[type=minecraft:armor_stand,tag=fall8,nbt={OnGround:1b}] at @s unless block ~ ~ ~ water unless block ~ ~ ~ seagrass unless block ~ ~ ~ tall_seagrass unless block ~ ~ ~ kelp_plant run setblock ~ ~ ~ minecraft:structure_block[mode=load]{metadata:"",mirror:"NONE",ignoreEntities:0b,powered:0b,seed:0L,author:"?",rotation:"NONE",posX:-5,mode:"LOAD",posY:-11,posZ:-5,integrity:1.0f,showair:0b,name:"minecraft:dungeon8",showboundingbox:1b}

execute as @e[type=minecraft:armor_stand,tag=fall8,nbt={OnGround:1b}] at @s if block ~ ~ ~ water run setblock ~ ~ ~ minecraft:structure_block[mode=load]{metadata:"",mirror:"NONE",ignoreEntities:0b,powered:0b,seed:0L,author:"?",rotation:"NONE",posX:-5,mode:"LOAD",posY:-5,posZ:-5,integrity:1.0f,showair:0b,name:"minecraft:dungeon5water",showboundingbox:1b}

execute as @e[type=minecraft:armor_stand,tag=fall8,nbt={OnGround:1b}] at @s if block ~ ~ ~ seagrass run setblock ~ ~ ~ minecraft:structure_block[mode=load]{metadata:"",mirror:"NONE",ignoreEntities:0b,powered:0b,seed:0L,author:"?",rotation:"NONE",posX:-5,mode:"LOAD",posY:-5,posZ:-5,integrity:1.0f,showair:0b,name:"minecraft:dungeon5water",showboundingbox:1b}

execute as @e[type=minecraft:armor_stand,tag=fall8,nbt={OnGround:1b}] at @s if block ~ ~ ~ tall_seagrass run setblock ~ ~ ~ minecraft:structure_block[mode=load]{metadata:"",mirror:"NONE",ignoreEntities:0b,powered:0b,seed:0L,author:"?",rotation:"NONE",posX:-5,mode:"LOAD",posY:-5,posZ:-5,integrity:1.0f,showair:0b,name:"minecraft:dungeon5water",showboundingbox:1b}

execute as @e[type=minecraft:armor_stand,tag=fall8,nbt={OnGround:1b}] at @s if block ~ ~ ~ kelp_plant run setblock ~ ~ ~ minecraft:structure_block[mode=load]{metadata:"",mirror:"NONE",ignoreEntities:0b,powered:0b,seed:0L,author:"?",rotation:"NONE",posX:-5,mode:"LOAD",posY:-5,posZ:-5,integrity:1.0f,showair:0b,name:"minecraft:dungeon5water",showboundingbox:1b}
...
execute as @e[type=minecraft:armor_stand,tag=fall9,nbt={OnGround:1b}] at @s unless block ~ ~ ~ water unless block ~ ~ ~ seagrass unless block ~ ~ ~ tall_seagrass unless block ~ ~ ~ kelp_plant run setblock ~ ~ ~ minecraft:structure_block[mode=load]{metadata:"",mirror:"NONE",ignoreEntities:0b,powered:0b,seed:0L,author:"?",rotation:"NONE",posX:-12,mode:"LOAD",posY:-8,posZ:-12,integrity:1.0f,showair:0b,name:"minecraft:dungeon9",showboundingbox:1b}

execute as @e[type=minecraft:armor_stand,tag=fall9,nbt={OnGround:1b}] at @s if block ~ ~ ~ water run setblock ~ ~ ~ minecraft:structure_block[mode=load]{metadata:"",mirror:"NONE",ignoreEntities:0b,powered:0b,seed:0L,author:"?",rotation:"NONE",posX:-2,mode:"LOAD",posY:0,posZ:-2,integrity:1.0f,showair:0b,name:"minecraft:dungeon9water",showboundingbox:1b}

execute as @e[type=minecraft:armor_stand,tag=fall9,nbt={OnGround:1b}] at @s if block ~ ~ ~ seagrass run setblock ~ ~ ~ minecraft:structure_block[mode=load]{metadata:"",mirror:"NONE",ignoreEntities:0b,powered:0b,seed:0L,author:"?",rotation:"NONE",posX:-2,mode:"LOAD",posY:0,posZ:-2,integrity:1.0f,showair:0b,name:"minecraft:dungeon9water",showboundingbox:1b}

execute as @e[type=minecraft:armor_stand,tag=fall9,nbt={OnGround:1b}] at @s if block ~ ~ ~ tall_seagrass run setblock ~ ~ ~ minecraft:structure_block[mode=load]{metadata:"",mirror:"NONE",ignoreEntities:0b,powered:0b,seed:0L,author:"?",rotation:"NONE",posX:-2,mode:"LOAD",posY:0,posZ:-2,integrity:1.0f,showair:0b,name:"minecraft:dungeon9water",showboundingbox:1b}

execute as @e[type=minecraft:armor_stand,tag=fall9,nbt={OnGround:1b}] at @s if block ~ ~ ~ kelp_plant run setblock ~ ~ ~ minecraft:structure_block[mode=load]{metadata:"",mirror:"NONE",ignoreEntities:0b,powered:0b,seed:0L,author:"?",rotation:"NONE",posX:-2,mode:"LOAD",posY:0,posZ:-2,integrity:1.0f,showair:0b,name:"minecraft:dungeon9water",showboundingbox:1b}
...
execute as @e[type=minecraft:armor_stand,tag=gen,tag=!fin,tag=struct,tag=dun10] at @s run setblock ~ 160 ~ minecraft:structure_block[mode=load]{metadata:"",mirror:"NONE",ignoreEntities:0b,powered:0b,seed:0L,author:"?",rotation:"NONE",posX:-5,mode:"LOAD",posY:0,posZ:-5,integrity:1.0f,showair:0b,name:"minecraft:dungeon10",showboundingbox:1b}
...
execute as @e[type=minecraft:armor_stand,tag=fall7,nbt={OnGround:1b}] at @s run setblock ~ ~1 ~ redstone_block

execute as @e[type=minecraft:armor_stand,tag=fall8,nbt={OnGround:1b}] at @s run setblock ~ ~1 ~ redstone_block

execute as @e[type=minecraft:armor_stand,tag=fall9,nbt={OnGround:1b}] at @s run setblock ~ ~1 ~ redstone_block
...
execute as @e[type=minecraft:armor_stand,tag=fall6] at @s if block ~ ~ ~ water run data modify entity @s Motion set value [0.0,-1.0,0.0]

execute as @e[type=minecraft:armor_stand,tag=fall6] at @s if block ~ ~ ~ kelp_plant run data modify entity @s Motion set value [0.0,-1.0,0.0]

execute as @e[type=minecraft:armor_stand,tag=fall7] at @s if block ~ ~ ~ water run data modify entity @s Motion set value [0.0,-1.0,0.0]

execute as @e[type=minecraft:armor_stand,tag=fall7] at @s if block ~ ~ ~ kelp_plant run data modify entity @s Motion set value [0.0,-1.0,0.0]

execute as @e[type=minecraft:armor_stand,tag=fall8] at @s if block ~ ~ ~ water run data modify entity @s Motion set value [0.0,-1.0,0.0]

execute as @e[type=minecraft:armor_stand,tag=fall8] at @s if block ~ ~ ~ kelp_plant run data modify entity @s Motion set value [0.0,-1.0,0.0]

execute as @e[type=minecraft:armor_stand,tag=fall9] at @s if block ~ ~ ~ water run data modify entity @s Motion set value [0.0,-1.0,0.0]

execute as @e[type=minecraft:armor_stand,tag=fall9] at @s if block ~ ~ ~ kelp_plant run data modify entity @s Motion set value [0.0,-1.0,0.0]


execute as @e[type=minecraft:armor_stand,tag=fall3] at @s run fill ~-13 ~ ~-13 ~13 ~-10 ~13 air replace #leaves

execute as @e[type=minecraft:armor_stand,tag=fall5] at @s run fill ~-1 ~ ~-1 ~1 ~-10 ~1 air replace #leaves

execute as @e[type=minecraft:armor_stand,tag=fall2] at @s run fill ~-1 ~ ~-1 ~1 ~-10 ~1 air replace #leaves

execute as @e[type=minecraft:armor_stand,tag=fall2] at @s run fill ~-1 ~ ~-1 ~1 ~-10 ~1 air replace #logs

execute as @e[type=minecraft:armor_stand,tag=fall3] at @s run fill ~-13 ~ ~-13 ~13 ~-10 ~13 air replace #logs

execute as @e[type=minecraft:armor_stand,tag=fall5] at @s run fill ~-1 ~ ~-1 ~1 ~-10 ~1 air replace #logs

execute as @e[type=minecraft:armor_stand,tag=fall6] at @s run fill ~-1 ~ ~-1 ~1 ~-10 ~1 air replace #logs

execute as @e[type=minecraft:armor_stand,tag=fall6] at @s run fill ~-1 ~ ~-1 ~1 ~-10 ~1 air replace #leaves

execute as @e[type=minecraft:armor_stand,tag=fall7] at @s run fill ~-1 ~ ~-1 ~1 ~-3 ~1 air replace #leaves

execute as @e[type=minecraft:armor_stand,tag=fall7] at @s run fill ~-1 ~ ~-1 ~1 ~-10 ~1 air replace #logs

execute as @e[type=minecraft:armor_stand,tag=fall8] at @s run fill ~-1 ~ ~-1 ~1 ~-3 ~1 air replace #leaves

execute as @e[type=minecraft:armor_stand,tag=fall8] at @s run fill ~-1 ~ ~-1 ~1 ~-10 ~1 air replace #logs

execute as @e[type=minecraft:armor_stand,tag=fall9] at @s run fill ~-1 ~ ~-1 ~1 ~-3 ~1 air replace #leaves

execute as @e[type=minecraft:armor_stand,tag=fall9] at @s run fill ~-1 ~ ~-1 ~1 ~-10 ~1 air replace #logs
...
execute as @e[type=minecraft:armor_stand,tag=fall7,nbt={OnGround:1b}] run kill @s

execute as @e[type=minecraft:armor_stand,tag=fall8,nbt={OnGround:1b}] run kill @s

execute as @e[type=minecraft:armor_stand,tag=fall9,nbt={OnGround:1b}] run kill @s

execute as @e[type=minecraft:armor_stand,tag=gen,tag=!fin,tag=struct,tag=dun1] at @s run setblock ~ ~11 ~ redstone_block

execute as @e[type=minecraft:armor_stand,tag=gen,tag=!fin,tag=struct,tag=dun10] at @s run setblock ~ 161 ~ redstone_block
